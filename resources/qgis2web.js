...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:31982',
            extent: [777014.900500, 9836916.081100, 778777.300500, 9839242.981100],
            units: 'm'})
    })
});
...
map.getView().fit([777031.899933, 9838172.367356, 778759.968196, 9839095.734303], map.getSize());
